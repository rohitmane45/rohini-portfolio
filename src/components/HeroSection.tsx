...
const HeroSection: React.FC = () => {
  ...
  const fullText = "AI/Data Science Student | Automation Specialist";
          ...
          >
            ...
            >
              <p className="text-base md:text-lg text-[var(--neuro-text-secondary)] max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                B.E. in Artificial Intelligence & Data Science (CGPA 9.59) | Building intelligent automation solutions,
